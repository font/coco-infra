...
### Region and VM Selection

CoCo peer pods require confidential VMs (AMD SEV-SNP or Intel TDX). Availability varies by region (as of April 2026):

| VM type | TEE | Regions (US) | Cost |
|---------|-----|-------------|------|
